...
tags:
  - JavaBase
date: 2019-03-28 11:26:09
categories: Java
description: Java反射技术，运行时获得类信息。
---
...
3. 加载结束后，JVM开始进行连接阶段（包含验证、准备、初始化）。经过这一系列操作，类的变量会被初始化。
...
![img](assets/169bab47c743e3ec)





![img](assets/169bab47c757bd35)



# 参考 #

1. [深入理解 Java 反射和动态代理](<https://juejin.im/post/5c9a4b10f265da60f6731913>)
